      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article, i) => (
            <article key={i} className="bg-card p-8 rounded-lg shadow-sm hover:shadow-xl border border-border transition-all duration-300 group flex flex-col h-full relative overflow-hidden">
